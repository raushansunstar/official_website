...
const DigitalAssets = lazy(() => import(/* webpackChunkName: "admin" */ './adminPanel/pages/DigitalAssets/DigitalAssets'));
const ManageCommission = lazy(() => import(/* webpackChunkName: "admin" */ './adminPanel/pages/Users/ManageCommission'));
...
const HotelsListingPage = lazy(() => import(/* webpackChunkName: "hotels-list" */ './pages/Hotels/HotelsListingPage'));
...
const Dining = lazy(() => import(/* webpackChunkName: "dining" */ './pages/Dining/Dining'));
        ...
        <AdminProvider>
          <PricingProvider>
            <Routes>
              ...
              <Route path="/admin/digital-assets" element={<PrivateRoute><DigitalAssets /></PrivateRoute>} />
              <Route path="/admin/manage-commission" element={<PrivateRoute><ManageCommission /></PrivateRoute>} />
